...
module.exports = {
  index: async (req, res) => {
    ...
    res.render('vendedores/index', { vendedores, title: 'Vendedores' });
  },
  newForm: (req, res) => {
    res.render('vendedores/form', { vendedor: {}, title: 'Novo Vendedor' });
  },
  ...
  editForm: async (req, res) => {
    ...
    res.render('vendedores/edit', { vendedor, title: 'Editar Vendedor' });
  },
  update: async (req, res) => {
    await Vendedor.update(req.params.id, req.body);
    res.redirect('/vendedores');
  },
